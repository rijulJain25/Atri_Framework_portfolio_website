...
class Atri:
	def __init__(self, state: Any):
		...
		self.Accordion5 = state["Accordion5"]
		self.Accordion6 = state["Accordion6"]
	...
	def Accordion5(self, new_state):
		...
		global default_state
		self._Accordion5 = Accordion(new_state, default_state["Accordion5"])
	...
	def Accordion6(self, new_state):
		...
		global default_state
		self._Accordion6 = Accordion(new_state, default_state["Accordion6"])
...
class AccordioncustomClass:
	def __init__(self, state, def_state):
		...
		self.open: List[Any] = get_defined_value(state, def_state, "open")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
...
class Accordion:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
		self.onTitleClick = False
		self.styles: AccordionstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: AccordioncustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = AccordionstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = AccordioncustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
