...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image10": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot_2022-12-22_at_8.46.11_AM-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image24": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/point-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image8": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot_2022-12-22_at_8.46.51_AM-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image9": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot_2022-12-22_at_8.47.04_AM-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image59": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot%202022-12-22%20at%207.18.40%20PM.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image65": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/arrow2-removebg-preview.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image92": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/photosample-modified.jpeg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image93": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot%202022-12-23%20at%206.25.23%20PM.png"
      },
      "callbacks": {
        "onClick": [
          {
